...
<div class="bg1"  >
	...
	<div class="product">
		<div class="container">
			<div class="spec ">
				<h3>Your Search Item <?php $i=$_GET['id']; echo " .....$i"; ?></h3>
				<div class="ser-t">
					<b></b>
					<span><i></i></span>
					<b class="line"></b>
				...
				<div class=" con-w3l">
							<?php  $i=$_GET['id']; search_product($i); ?>
							<div class="clearfix"></div>
						 </div>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="clearfix"></div>
			<div class="footer-bottom">
				<h2 ><a href="index.html"><b>T<br>H<br>E</b>Armed Medicine And Food<span>only for foodies</span></a></h2>
