...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 style="font-size: 40px;"><a href="index.html"><b>T<br>H<br>E</b>Armed Medicine And Food!<span>A Help To Indian Army !Supply of Medicine  <br>sAnd Food To The Army At Peaks</span></a></h1>
			</div>
	...
	<div class="login">
		<div class="main-agileits">
				<div class="form-w3agile form1">
					<h3>Register</h3>
					<?php $i=$_GET['id'];
					if ($i=='error') {echo "<p style='font-size:30px;color:red;'>Please Fill Correct Info</p>";
					  	# code...
					  }  ?>
					<form action="registerupload.php" method="post">
						<div class="key">
							<i class="fa fa-user" aria-hidden="true"></i>
							<input  type="text" value="Enter unique CRPF ID" name="username" id="username" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter unique CRPF ID';}"  required>
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa " aria-hidden="true"></i>
							<input  type="text" value="Enter Name" name="name" id="name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter Name';}"  required>
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa " aria-hidden="true"></i>
							<input  type="text" value="Enter Contact Number" name="number" id="number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter Contact Number';}"  required>
							<div class="clearfix"></div>
						</div>
						<div class="key">
